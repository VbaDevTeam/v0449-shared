...
namespace v0449_shared
{
  ...
  public static class S7
  {
    ...
    #region Get/Set 16 bit signed value (S7 int) -32768..32767
    public static int GetSwIntAt(byte[] Buffer, int Pos)
    {
      return (int)((Buffer[Pos + 1] << 8) | Buffer[Pos]);
    }
    public static void SetSwIntAt(byte[] Buffer, int Pos, Int16 Value)
    {
    ...
    #region Okkio: Get/Set 16 bit swapped unsigned value (S7 UInt) 0..65535
    public static UInt16 GetSwUIntAt(byte[] Buffer, int Pos)
    {
      return (UInt16)((Buffer[Pos + 1] << 8) | Buffer[Pos]);
    }
    public static void SetSwUIntAt(byte[] Buffer, int Pos, UInt16 Value)
    {
      Buffer[Pos + 1] = (byte)(Value >> 8);
      Buffer[Pos] = (byte)(Value & 0x00FF);
    }
    ...
    #region Okkio: Get/Set 16 bit swapped word (S7 Word) 16#0000..16#FFFF
    public static UInt16 GetSwWordAt(byte[] Buffer, int Pos)
    {
      return GetSwUIntAt(Buffer, Pos);
    }
    public static void SetSwWordAt(byte[] Buffer, int Pos, UInt16 Value)
    {
      SetSwUIntAt(Buffer, Pos, Value);
    }
    #endregion
