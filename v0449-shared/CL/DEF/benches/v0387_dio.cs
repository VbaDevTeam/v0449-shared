  ...
  public class _0387dio
	{
		...
		public wBitInt[] Wa= new wBitInt[]
		{
			new wBitInt((int)wBitInt.types.Wa, 0, "Wa00", "Wa00", new lBitInt[]
			{
				...
				new lBitInt(6, "AL0_6_DRaP120_OK_", "06 - anomaliza drive pompa mandata"),
				...
				new lBitInt(10, "AL0_a_DRaP200_OK_", "10 - anom. drive pompa circolazione"),
				...
				new lBitInt(15, "AL0_f_DRaS230_OK_", "15 - anomalia drive siringa")
			}),


			new wBitInt((int)wBitInt.types.Wa, 1, "Wa01", "Wa01", new lBitInt[]
			{
				new lBitInt(0, "AL1_0_TSaR210_OK_", "16 - termostato sicurezza riscaldatore"),
				...
				new lBitInt(4, "AL1_4_DRaP530_OK_", "20 - anomalia drive pompa raffreddamento"),
			...
			new wBitInt((int)wBitInt.types.Wa, 2, "Wa02", "Wa02", new lBitInt[]
			{
				...
				new lBitInt(6, "AL2_6_SBaSCOPTUBO", "38 - Anomalia pulsazione scoppio tubo"),
				new lBitInt(7, "AL2_7_All_Riserva", "39 - Riserva"),
				new lBitInt(8, "AL2_8_All_Riserva", "40 - Riserva"),
				new lBitInt(9, "AL2_9_All_Riserva", "41 - Riserva"),
				new lBitInt(10, "AL2_a_All_Riserva", "42 - Riserva"),
				new lBitInt(11, "AL2_b_All_Riserva", "43 - Riserva"),
				new lBitInt(12, "AL2_c_All_Riserva", "44 - Riserva"),
				new lBitInt(13, "AL2_d_All_Riserva", "45 - Riserva"),
				new lBitInt(14, "AL2_e_All_Riserva", "46 - Riserva"),
				new lBitInt(15, "AL2_f_All_Riserva", "dummy")
			})
		};
	}
}
